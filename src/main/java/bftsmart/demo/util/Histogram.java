 ...
 * @author pavlo
 */
// public class Histogram<X extends Comparable<X>> extends JSONSerializable {
public class Histogram<X extends Comparable<X>> {
     ...
     * count This should be
     * called by one of the public interface methods that are synchronized This
     * method is not
    ...
    private void _put(X value, int count) {
        ...
        // If the new count is zero, then completely remove it if we're not allowed to
        // have zero entries
    ...
    /**
     * Recalculate the min/max count value sets Since this is expensive, this should
     * only be done
    ...
    /**
     * Get the largest value entered into the histogram This assumes that the values
     * implement the
     * Comparable interface
     *
     * @return
    ...
    /**
     * Returns the current count for the given value If the value was never entered
     * into the
